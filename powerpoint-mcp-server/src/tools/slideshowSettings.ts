...
export const pptSlideshowSettingsTool = createActionTool({
...
- reset: 重置放映设置`,
  ...
  paramRules: {
    setLoop: [required('loop', 'boolean')],
    setAdvanceMode: [required('advanceMode', 'string')],
    setPresenterView: [required('presenterView', 'boolean')],
    setKioskMode: [required('kioskMode', 'boolean')],
    setResolution: [required('resolution', 'string')],
    setDisplay: [required('displayMonitor')]
  },
  properties: {
    loop: {
      type: 'boolean',
