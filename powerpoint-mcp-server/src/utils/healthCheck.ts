...
export class HealthChecker {
  ...
  constructor(serverName: string = 'powerpoint-mcp-server') {
...
export const globalHealthChecker = new HealthChecker('powerpoint-mcp-server')
