 ...
 * 创建健康检查器工厂函数
 */
export function createHealthChecker(serverName: string): HealthChecker {
  return new HealthChecker(serverName)
}

// 默认健康检查器实例（可被各 MCP Server 覆盖）
export const globalHealthChecker = new HealthChecker('mcp-server')
